...
export const NativeSelectField = ({ className, ...props }: React.JSX.IntrinsicElements['div']) => {
...
export const NativeSelect = ({ className, ...props }: React.JSX.IntrinsicElements['select']) => {
	...
	return (
		<div
			...
			className={twMerge(
				...
				'after:inset-e-3 after:bottom-[55%] after:-translate-x-1/2 after:translate-y-1/2 after:rotate-45 rtl:after:translate-x-1.5',
			)}
		>
			<select
				{...focusProps}
