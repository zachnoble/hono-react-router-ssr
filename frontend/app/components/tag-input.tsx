...
export const TagsInputField = ({ list, name, onTagRemove, onTagAdd, ...props }: TagInputProps) => {
	return (
...
export const TagsInput = ({ className }: { className?: string; children?: React.ReactNode }) => {
	...
	const handleRemove = (keys: Set<Key>) => {
		...
		if (firstKey !== undefined) {
			const item = list.getItem(firstKey)
	...
	return (
		...
		>
			...
			>
				<div className='inline-flex flex-1 flex-wrap items-center gap-1 px-2 py-1.25'>
