...
export const GridList = <T extends object>({ children, ...props }: GridListProps<T>) => {
	return (
		<AriaGridList
			{...props}
		...
		<AriaGridListItem
			...
			className={composeRenderProps(
				...
				(className, { isFocusVisible, isSelected, isDisabled, isHovered }) =>
					twMerge(
						'relative -mb-px flex cursor-pointer select-none gap-3 rounded-md px-2 py-1.5 text-sm outline-hidden',
						'not-last:mb-0.5',
						isHovered && ['bg-subtle'],
						isSelected && ['z-20'],
