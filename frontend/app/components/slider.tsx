...
export const SliderTack = ({ thumbLabels }: { thumbLabels?: string[] }) => {
	return (
							...
							<SliderThumb
								...
								className={composeRenderProps(
									...
									(className, { isFocusVisible, isDragging, isDisabled }) =>
										twMerge(
											'size-4 cursor-pointer rounded-full border-2 border-accent bg-[lch(from_var(--color-accent)_calc((49.44-l)*infinity)_0_0)] shadow-xl dark:border-3',
