...
export const CalloutIcon = ({ className, ...props }: React.JSX.IntrinsicElements['div']) => {
	return (
		<div
			{...props}
...
export const CalloutDescription = ({ className, id, ...props }: Omit<TextProps, 'elementType'>) => {
...
export const CalloutActions = ({ className, ...props }: React.JSX.IntrinsicElements['div']) => {
