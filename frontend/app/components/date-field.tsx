			...
			{(segment) => (
				<DateSegment
					...
					className={twMerge(
						...
						'focus:bg-accent focus:text-[lch(from_var(--color-accent)_calc((49.44-l)*infinity)_0_0)] focus:data-placeholder:text-[lch(from_var(--color-accent)_calc((49.44-l)*infinity)_0_0)]',
					)}
				/>
			)}
		</RACDateInput>
